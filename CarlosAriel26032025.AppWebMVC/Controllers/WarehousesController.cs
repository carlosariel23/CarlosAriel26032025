...
namespace CarlosAriel26032025.AppWebMVC.Controllers
{
    public class WarehousesController : Controller
    {
        ...
        public async Task<IActionResult> Index(Warehouse bodega, string? warehouseName, int topRegistro = 10, int page = 1)
        {
            ...
            var totalPages = (int)Math.Ceiling(totalCount / (double)topRegistro); 
            query = query.Skip((page - 1) * topRegistro).Take(topRegistro);
